...
class GlmMoeDsaXliteModel(DeepseekV3XliteModel):
    """xlite adapter for GLM MoE architectures with dynamic sparse attention (DSA)."""

    _attn_metadata_type = AscendSFAMetadata
    _supported_architectures = ["GlmMoeDsaForCausalLM"]
